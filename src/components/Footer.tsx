    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-display font-bold text-gradient-primary mb-4">NEXUS</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 uppercase tracking-wide">Quick Links</h4>
          ...
          {/* Categories */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 uppercase tracking-wide">Categories</h4>
            <ul className="space-y-3">
          ...
          {/* Social */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 uppercase tracking-wide">Follow Us</h4>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">© 2025 NEXUS Athletics. All rights reserved.</p>
